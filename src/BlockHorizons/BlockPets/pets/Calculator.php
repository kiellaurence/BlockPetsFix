...
class Calculator {
	...
	public function updateNameTag(): void {
		...
		$pet->setNameTag("§l§6♦§b " . $pet->getPetName() . "§6 ♦\n" .
			TextFormat::GREEN . "§l§f(§aCấp§f: " . TextFormat::AQUA . $pet->getPetLevel() . TextFormat::DARK_AQUA . "§f) §f( §a" . TextFormat::YELLOW . $percentage . TextFormat::DARK_AQUA . "§e% §f) §l§e" . TextFormat::LIGHT_PURPLE . $pet->getName() .
			TextFormat::RED . " §l§f( §e" . $pet->getHealth() . "§f/§c" . $pet->getMaxHealth() . " §f)"
		);
	}
}
